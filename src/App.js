...
export default function Game() {
  ...
  return (
    <div className="game ml-24 mt-10 ">
        <Col xs={3}>
        ...
        <Col xs={7}>
          <div className=''>
            <p className='ml-10'>Rules: <br /> The rules for 3D tictactoe are the same except for these changes Instead of a 3x3 grid, you have three 3x3 boards stacked on top of each  other, forming a 3D cube. <br />1. Each board represents a different plane in the cube: top, middle, and bottom. <br />2. Winning Condition: In addition to winning on a 2D plane (horizontal, vertical, or diagonal lines), players can also win by forming a line across the three boards in the 3D space. This includes lines that span across different planes of the cube.<br /> 3. Vertical Lines: A vertical winning line is formed by aligning three symbols (X or O) vertically in the same column across the three boards. For example, if a player places their symbols in the top-left cell of the top board, the middle board, and the bottom board, they would form a vertical winning line.<br /> 4. Single-Board Lines: Players can still win by forming a line within a single board, following the traditional Tic-Tac-Toe rules of forming horizontal, vertical, or diagonal lines.</p>
          </div>
        </Col>
